					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<li class="nav-item dropdown">
								<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img id="topProfilePhoto" src="/assets/img/profile.jpg" alt="user-img" width="36" class="img-circle"><span id="topProfileName">Admin</span></a>
									...
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted" id="menuProfileEmail">admin@example.com</p><a href="/admin/profile" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
											</div>
										</li>
									<div class="dropdown-divider"></div>
